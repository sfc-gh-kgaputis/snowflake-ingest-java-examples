...
public class SnowflakeIngestBasicExample {
    ...
    private static String account = System.getenv("SNOWFLAKE_ACCOUNT");
    private static String user = System.getenv("SNOWFLAKE_USER");
    private static String host = account + ".snowflakecomputing.com";
    private static String scheme = "https";
    private static String password = System.getenv("SNOWFLAKE_PASSWORD");
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            System.out.println("Starting ingest process...");
